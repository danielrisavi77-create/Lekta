...
--
-- Ova migracija je bila primijenjena na produkciju (verzija 20260805184312) ali NIKAD nije
...
-- do istog stanja.
grant insert on table public.academic_audit_runs to authenticated;
grant insert on table public.academic_audit_findings to authenticated;
