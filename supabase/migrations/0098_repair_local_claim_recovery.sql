alter table public.repair_local_jobs
  add column claim_recovery_token_sha256 text unique check (
...
-- Clean rows that may have expired between 0096/0097 and this forward migration.
...
create index repair_local_jobs_recoverable_expiry
