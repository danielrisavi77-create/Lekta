...
import { renderProfileCard, sampleSummary } from './profile-card';
...
function renderSubmissionChecklist(r: any){
 ...
 // Signal spremnosti na oba izlaza: vidi src/ui/result-ready-signal.ts.
 settleResultRenderAfter(runtimeDocument,r&&repairPanelForResult===r?null:()=>renderRepairSection(r).catch((e: any)=>console.error('Repair panel:',e)));
}
