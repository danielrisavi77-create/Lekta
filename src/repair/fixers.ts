...
export { citationBibliographySyncFixer } from './citation-bibliography-sync-fixer.ts';
export { legalFootnoteRepairFixer } from './legal-footnote-repair-fixer.ts';
export { finalDocumentInspectorFixer } from './final-document-inspector-fixer.ts';
export { tableFigureRescueFixer } from './table-figure-rescue-fixer.ts';
export { sectionSurgeryFixer } from './section-surgery-fixer.ts';
export { fieldIntegrityFixer } from './field-integrity-fixer.ts';
export { croatianTypographyFixer } from './croatian-typography-fixer.ts';
export { consistencyFixer } from './consistency-fixer.ts';
export { requiredSectionFixer } from './required-section-fixer.ts';
export { linkDoiFixer } from './link-doi-fixer.ts';
export { submissionMetadataFixer } from './submission-metadata-fixer.ts';
