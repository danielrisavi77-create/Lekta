...
QUOTE   : Dujanić, M., Osnove menadžmenta, Veleučilište u Rijeci, Rijeka, 2006.   [grep: OK]
...
QUOTE   : Horvat, Đ., Nedović Čubarkapa, M., Učinkovitost upravljanja dobavnim lancem primjenom   [grep: OK]
...
QUOTE   : Pašalić, Ž., Prometni sustavi i prometna tržišta, Suvremeni promet, vol. 29, 2009., br. 1-2, str.   [grep: OK]
...
QUOTE   : Na kraju rada slijedi Popis korištene literature koju navodimo ovako (ili odabrati stil APA 6):   [grep: OK]
...
QUOTE    : (Dujani, 2020, 55).   [grep: NIJE NADJEN u ekstrakciji!]
